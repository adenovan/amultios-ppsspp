...
enum {
	...
	VIRTKEY_OPENCHAT = 0x40000017,
#ifdef MOBILE_DEVICE
	VIRTKEY_CHAT = 0x40000018,
#endif // MOBILE_DEVICE
	VIRTKEY_QUICKCHAT1 = 0x40000019,
	VIRTKEY_QUICKCHAT2 = 0x40000020,
	VIRTKEY_QUICKCHAT3 = 0x40000021,
	VIRTKEY_QUICKCHAT4 = 0x40000022,
	VIRTKEY_QUICKCHAT5 = 0x40000023,
	VIRTKEY_LAST,
